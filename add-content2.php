<?php
include("db.php");
$idconent = $_POST['ID_Content'];
$headcontent = $_POST['HEAD_Content'];
$detail = $_POST['Detail_Content'];
//$pic = $_POST['PIC_HOME'];
$img_content = $_FILES["x"]["name"];
...
<html lang="en">
  ...
  <div class="container">
    ...
    $sql = "INSERT INTO content VALUES ('$idconent','$headcontent','$detail','".$_FILES["x"]["name"]."')";
    ...
    if ($result) {
        ...
        <div class="detail">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="ad-showcontent.php" class="btn btn-info">submit</a>
                </div>
            </div>
        </div>
        <?php
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="add-content.php" class="btn btn-danger">submit</a>
            </div>
        </div>
        <?php
    }
