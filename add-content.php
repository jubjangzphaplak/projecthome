...
<body class="animsition">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="container">
                                <div class="container">
                                <form action="add-content2.php" method="post" enctype="multipart/form-data">
  ...
  <h4 style="text-align: center">เพิ่มบทความที่น่าสนใจ</h4><br>
  <table class="table table-hover table-primary">
  <thead>
  <tr >
  <th  ><label class="" for="val-type">เลือกรูป <span class="text-danger">*</span></label></th>
  ...
  <td width="200"> <input type="file" name="x" size="50">
     ...
     <tr >
    <th  >อันดับ</th>
    <td width="200"><input type="text" name="ID_Content" size="20" required></td>
    </tr>
     <tr >
    <th  >หัวข้อบทความ</th>
    <td width="200"><input type="text" name="HEAD_Content" size="20" required></td>
    </tr>
  <tr>
    <th  >เนื้อหาบทความ</th>
    <td width="200"><input type="text" name="Detail_Content" size="20" required></td>
    </tr>
  ...
  <br>
  <center><input type="submit" name="save" class="btn  btn-success btn-lg"  value="เพิ่มบทความ">
